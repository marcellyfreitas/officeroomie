...
const formSchema = z.object({
	...
	cpassword: z.string().min(3, 'A senha deve ter pelo menos 3 caracteres'),
	cpf: z.string()
...
export default function RegisterScreen() {
	const { control, handleSubmit, formState: { errors } } = useForm<InnerFormData>({
		...
		defaultValues: {
			name: 'Usuário externo 1',
			email: 'usuarioexterno1@email.com',
			cpf: '56925416610',
			password: 'senha',
			cpassword: 'senha',
		},
					...
					<View className="flex flex-col w-full gap-5">
						...
						<View className="flex flex-col w-full gap-4">
							...
							<Button
								...
								disabled={loading}
							>
								<Text className="font-bold text-slate-50">Salvar</Text>
							</Button>
